...
> [!TIP]
> You can keep your host environment clean by setting up MarkdownNotes within a [distrobox](https://distrobox.it) container that has [podman enabled](https://github.com/89luca89/distrobox/blob/main/docs/useful_tips.md#using-podman-inside-a-distrobox).
